...
import pika
import json
from com.abin.lee.util import CharacterUtil,UuidUtil,NumberUtil,IdNoUtil,MobileUtil,BankCardUtil


def send(idNo, taskType, uniqKey, realName, userKey, mobile, creditCardNo, cardNo, reserveMobile):
...
"""
    ...
    body['data']['userBasicInfo']['cardNo'] = cardNo
...
if __name__ == "__main__":
    for i in range(0, 10):
        ...
        cardNo = BankCardUtil.visa16(0)
        # taskType = sys.argv[1]
        taskType = 1
        # taskType = NumberUtil.randomNumber(5, 10)
        # taskType = sys.argv[1]
        print "idNo="+idNo
        send(idNo, taskType, uniqKey, realName, userKey, mobile, creditCardNo, cardNo, reserveMobile)